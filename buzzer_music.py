...
#Tiempo, Nota, Duración, Instrumento (formato esquemático de onlinesequencer.net)
#0 D4 8 0;0 D5 8 0;0 G4 8 0;8 C5 2 0;10 B4 2 0;12 G4 2 0;14 F4 1 0;15 G4 17 0;16 D4 8 0;24 C4 8 0

class song:
    def __init__(self, title='NA', songString='0 D4 8 0', looping=False, tempo=3, duty=2512, pin=None, pins=[Pin(0)]):
        self.title = title
        self.tempo = tempo
        ...
        #Encuentra el final de la canción
        self.end = 0
        ...
        #Crea una estructura vacía de la canción
        while (self.end > len(self.notes)):
            self.notes.append(None)

        #Pobla la estructura de la canción con las notas
        for note in splitSong:
            snote = note.split(" ")
            ...
            if (self.notes[beat] == None):
                self.notes[beat] = []
            self.notes[beat].append([snote[1],ceil(float(snote[2]))]) #Nota, Duración


        #Redondea el final de la canción al compás más cercano
    ...
    def tick(self):
        if (not self.stopped):
            ...
            if (self.timer % self.tempo == 0):
                ...
                #Eliminar notas caducadas de la lista de reproducción
                i = 0
                ...
                #Añade nuevas notas y sus duraciones a la lista de reproducción.
                ...
                #Sólo es necesario ejecutar estas comprobaciones en los ritmos.
                i = 0
                for pwm in self.pwms:
            ...
            #Toca un arpegio con todas las notas que están sonando
